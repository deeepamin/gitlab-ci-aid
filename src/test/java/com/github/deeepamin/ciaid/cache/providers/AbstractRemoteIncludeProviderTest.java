...
public class AbstractRemoteIncludeProviderTest extends BaseTest {
  ...
  private String getMatchingProjectPath(List<Remote> remotes, String projectPath) {
    ...
    return remoteIncludeProvider.getMatchingProjectPath(remoteIncludeProvider.getProjectPath());
  }
